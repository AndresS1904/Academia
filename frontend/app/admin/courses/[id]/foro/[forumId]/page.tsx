    ...
    <div style={{ background: "#f8fafc", borderRadius: 10, padding: "12px 14px", border: "1px solid #e2e8f0" }}>
      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8 }}>
        ...
        <div style={{ flex: 1 }}>
          ...
          {isAdmin && <span style={{ marginLeft: 6, padding: "1px 6px", background: "#fef3c7", color: "#92400e", borderRadius: 10, fontSize: "0.65rem", fontWeight: 700 }}>Admin</span>}
        </div>
...
export default function AdminCourseForumPage() {
  ...
  if (loading || fetching) return (
    <div style={{ minHeight: "100vh", background: "#f0f4ff" }}><AdminSidebar />
