          ...
          <main className="dashboard-main">
            <div className="dashboard-content" style={{ maxWidth: 700 }}>
              ...
              <div style={{ textAlign: "center" }}>
                <Link href={`/dashboard/clases/${classroomId}`} style={{ padding: "10px 24px", background: "#004aad", color: "#fff", borderRadius: 10, textDecoration: "none", fontWeight: 700 }}>Volver al aula</Link>
              </div>
            </div>
          </main>
        </div>
              ...
              <div style={{ textAlign: "center" }}>
                {canStart ? (
                  <button onClick={startAttempt} disabled={starting} style={{ padding: "12px 32px", background: "#004aad", color: "#fff", border: "none", borderRadius: 10, cursor: "pointer", fontWeight: 800, fontSize: "1rem" }}>
                    {starting ? "Iniciando…" : "Comenzar quiz"}
                  </button>
                ) : (
