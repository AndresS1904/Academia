...
export default function TopicActivitySubmissionsPage() {
                  ...
                  <div style={{ padding: "16px 18px" }}>
                    ...
                    <div style={{ borderTop: "1px solid #e2e8f0", paddingTop: 16 }}>
                      ...
                      <textarea placeholder="Retroalimentación (opcional)" value={gradeFeedback} onChange={(e) => setGradeFeedback(e.target.value)} rows={3}
                        style={{ padding: "8px 10px", borderRadius: 8, border: "1.5px solid #c7d7f0", fontSize: "0.82rem", width: "100%", marginBottom: 10, boxSizing: "border-box" as const, resize: "vertical" }} />
