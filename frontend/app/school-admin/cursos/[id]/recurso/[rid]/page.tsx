...
export default function RecursoAdminPage() {
  const { user } = useAuth();
    ...
    <div style={{ minHeight: "100vh", background: "#f0f4ff" }}>
      ...
      <main style={{ marginLeft: 260, padding: "28px 36px", minHeight: "100vh", boxSizing: "border-box" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 24 }}>
          <Link href={`/school-admin/cursos/${courseId}`} style={{ padding: "7px 13px", background: "#fff", border: "1px solid #e2eaf7", borderRadius: 9, color: "#475569", textDecoration: "none", fontSize: "0.83rem", fontWeight: 600 }}>← Volver</Link>
          <div>
              ...
              : data.activities.map(a => (
                <div key={a.id} style={{ ...card, padding: "14px 18px" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                    ...
                    <Link href={`/school-admin/cursos/${courseId}/actividad/${a.id}`}
              ...
              : data.quizzes.map(q => (
                <div key={q.id} style={{ ...card, padding: "14px 18px" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    ...
                    <Link href={`/school-admin/cursos/${courseId}/quiz/${q.id}`}
              ...
              : data.forums.map(f => (
                <div key={f.id} style={{ ...card, padding: "14px 18px" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    ...
                    <Link href={`/school-admin/cursos/${courseId}/foro/${f.id}`}
                      style={{ padding: "6px 14px", background: "#f0f4ff", color: "#004aad", border: "1px solid #c7d7f0", borderRadius: 8, textDecoration: "none", fontSize: "0.78rem", fontWeight: 700 }}>
                      Gestionar →
                    </Link>
                  </div>
